...
var (
	...
	SchedulingLoopDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "scheduling_loop_duration_milliseconds",
			Help:    "The duration of a scheduling loop",
			Buckets: []float64{10, 25, 50, 100, 250, 500, 1000, 2500, 5000, 10000, 25000, 50000},
		},
		[]string{
			"is_loop_failed",
		},
