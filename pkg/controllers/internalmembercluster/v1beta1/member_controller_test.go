...
func (p *failedToStartProvider) Collect(ctx context.Context) propertyprovider.PropertyCollectionResponse {
	return propertyprovider.PropertyCollectionResponse{}
}
...
func (p *startTimedOutProvider) Collect(ctx context.Context) propertyprovider.PropertyCollectionResponse {
	return propertyprovider.PropertyCollectionResponse{}
}
