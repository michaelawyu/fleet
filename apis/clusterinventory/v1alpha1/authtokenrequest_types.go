...
// +genclient
// +kubebuilder:object:root=true
// +kubebuilder:resource:scope=Namespaced,categories={cluster-inventory},shortName=iatr
// +kubebuilder:subresource:status
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
...
type AuthTokenRequestSpec struct {
	...
	// ServiceAccountNamespace is the namespace where the service account is created. This namespace
...
// InternalAuthTokenRequestList contains a list of InternalAuthTokenRequests.
type InternalAuthTokenRequestList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []InternalAuthTokenRequest `json:"items"`
}

func init() {
	SchemeBuilder.Register(&AuthTokenRequest{},
		&AuthTokenRequestList{},
		&InternalAuthTokenRequest{},
		&InternalAuthTokenRequestList{})
}
